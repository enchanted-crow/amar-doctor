...
public interface DoctorService {
    ...
    Doctor registerUser(String email, String password, String name, String contact_no, String doctor_type, String department, String designation, String institution, String degrees, String chamber_location, Integer bmdc_registration_number, Integer bmdc_registration_year, String bio, Byte[] photo, List<TimeSlot> time_slot) throws UserAuthException;
    Doctor viewProfileById(Integer id);
