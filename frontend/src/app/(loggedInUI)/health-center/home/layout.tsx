...
export default function DashboardLayoutHCenter({
          ...
          <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
              ...
              <Link className="flex items-center gap-x-2 font-medium text-gray-500 hover:text-blue-600 sm:border-l sm:border-gray-300 sm:my-6 sm:pl-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-blue-500" href="#">
                ...
                <p className="ml-1 pt-1">হোপ হেলথ সেন্টার</p>
              </Link>
            </div>
          </div>
        </nav>
              ...
              <div>
                <li>
                  <Link className={
                    ...
                    href="/health-center/home/current-meeting"
                ...
                <li>
                  <Link className={
                    ...
                    href="/health-center/home/patient-list"
              ...
              <div>
                <li>
                  <Link className={
                    ...
                    href="/health-center/home/new-appointment"
